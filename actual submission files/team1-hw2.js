...
*/
  $.fn.defaults = {
    ...
    { // Has to return $.fn.defaults
      // This function sets the optiosn in the $.fn.defaults plugin object.
    ...
    {
      /*
        Function used to generate the entire game's tag elements into the specified jQuery object.
        The jQuery object is supplied by $.fn.defaults.game_elem
      */
      ...
      $(document).ready(function(){
        ...
        // This essentially controls what happens during the game
        $("#random_circ").click(function() {
          if (data.game_state.turns_left == 0)
          { // If the game has no more turns left do this
          ...
          { // If there are still turns left do this
  ...
  { // difficulty is in options.difficulty  turns is in options.turns
  	// This is the main function called to start/restart the game
  ...
  { // This function is used to disable the difficulty and number of turns inputs
